    ...
    <form className='w-1/3 mx-auto py-10' onSubmit={(e) => e.preventDefault()}>
      ...
      <label className='text-xs text-white opacity-7'>
        ...
        <textarea
          ...
          className='mt-1 text-black w-full rounded-lg bg-gray-400 border py-1 px-2 text-xs outline-none resize-none h-40 placeholder:text-gray-700 cursor-pointer'
        />
      </label>
